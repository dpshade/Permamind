...
export class WorkflowRelationshipManager {
  ...
  private hasProducerConsumerPattern(links1: MemoryLink[], links2: MemoryLink[]): boolean {
  ...
  private hasRequirementCapabilityMatch(links1: MemoryLink[], links2: MemoryLink[]): boolean {
  ...
  private hasComplementaryRelationshipTypes(links1: MemoryLink[], links2: MemoryLink[]): boolean {
