...
import type { RelationshipType, Enhancement } from "../../../src/models/WorkflowMemory.js";
...
describe("WorkflowRelationshipManager", () => {
  ...
  describe("createRelationship", () => {
    it("should create relationship between workflows", () => {
      expect(() => {
        manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 0.8);
      }).not.toThrow();
    });
    ...
    it("should handle all relationship types", () => {
      ...
      relationshipTypes.forEach(type => {
        expect(() => {
          manager.createRelationship(testWorkflowId1, testWorkflowId2, type, 0.5);
        }).not.toThrow();
      });
    });
    ...
    it("should handle relationship strength validation", () => {
      ...
      [0, 0.5, 1.0].forEach(strength => {
        expect(() => {
          manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", strength);
        }).not.toThrow();
      });
    });
    ...
    it("should handle duplicate relationship creation", () => {
      ...
      expect(() => {
        manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 0.9);
      }).not.toThrow();
    });
  });
  ...
  describe("getRelatedWorkflows", () => {
    it("should return related workflows by type", () => {
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 0.8);
      manager.createRelationship(testWorkflowId1, testWorkflowId3, "composes", 0.6);

      const inheritedWorkflows = manager.getRelatedWorkflows(testWorkflowId1, "inherits");
      const composedWorkflows = manager.getRelatedWorkflows(testWorkflowId1, "composes");
    ...
    it("should return empty array for workflows with no relationships", () => {
      const related = manager.getRelatedWorkflows("nonexistent-workflow", "inherits");
      expect(related).toHaveLength(0);
    });

    it("should return empty array for unknown relationship types", () => {
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 0.8);
      const related = manager.getRelatedWorkflows(testWorkflowId1, "unknown" as RelationshipType);
      expect(related).toHaveLength(0);
    });
  });
  ...
  describe("findCollaborationOpportunities", () => {
    it("should find collaboration opportunities between workflows", () => {
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "supports", 0.7);
      manager.createRelationship(testWorkflowId2, testWorkflowId3, "enhances", 0.8);

      const opportunities = manager.findCollaborationOpportunities(testWorkflowId1);
    ...
    it("should return empty opportunities for isolated workflows", () => {
      const opportunities = manager.findCollaborationOpportunities("isolated-workflow");
    ...
    it("should handle workflows with complex relationship networks", () => {
      ...
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 0.8);
      manager.createRelationship(testWorkflowId2, testWorkflowId3, "composes", 0.7);
      manager.createRelationship(testWorkflowId3, testWorkflowId1, "enhances", 0.6);

      const opportunities = manager.findCollaborationOpportunities(testWorkflowId1);

      expect(opportunities.potentialPartners.length + opportunities.compositionOpportunities.length)
  ...
  describe("getDependentWorkflows", () => {
    it("should find workflows that depend on target workflow", () => {
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "depends_on", 0.9);
      manager.createRelationship(testWorkflowId3, testWorkflowId2, "composes", 0.7);
  ...
  describe("optimizeRelationships", () => {
    it("should optimize relationships based on performance data", () => {
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 0.3); // Weak relationship
      manager.createRelationship(testWorkflowId1, testWorkflowId3, "composes", 0.9); // Strong relationship
    ...
    it("should handle optimization with empty performance data", () => {
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 0.5);
  ...
  describe("propagateEnhancement", () => {
    it("should propagate enhancement to related workflows", () => {
      manager.createRelationship(testWorkflowId2, testWorkflowId1, "inherits", 0.8); // workflow2 inherits from workflow1
    ...
    it("should handle deferred propagation strategy", () => {
      manager.createRelationship(testWorkflowId2, testWorkflowId1, "inherits", 0.8);
  ...
  describe("circular dependency detection", () => {
    it("should detect circular dependencies", () => {
      ...
      manager.createRelationship(testWorkflowId1, testWorkflowId2, "depends_on", 0.5);
      manager.createRelationship(testWorkflowId2, testWorkflowId3, "depends_on", 0.5);
      manager.createRelationship(testWorkflowId3, testWorkflowId1, "depends_on", 0.5);
  ...
  describe("error handling and edge cases", () => {
    it("should handle null workflow IDs", () => {
      expect(() => {
        manager.createRelationship(null as any, testWorkflowId2, "inherits", 0.5);
      }).not.toThrow();

      expect(() => {
        manager.createRelationship(testWorkflowId1, null as any, "inherits", 0.5);
      }).not.toThrow();
    });

    it("should handle undefined workflow IDs", () => {
      expect(() => {
        manager.createRelationship(undefined as any, testWorkflowId2, "inherits", 0.5);
      }).not.toThrow();
    });
    ...
    it("should handle invalid relationship strengths", () => {
      ...
      expect(() => {
        manager.createRelationship(testWorkflowId1, testWorkflowId2, "inherits", 1.5);
      }).not.toThrow();
    });

    it("should handle self-referential relationships", () => {
      expect(() => {
        manager.createRelationship(testWorkflowId1, testWorkflowId1, "inherits", 0.5);
      }).not.toThrow();
